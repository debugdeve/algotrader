...
exports.ZeptoScraper = void 0;
const QCommerceScraper_1 = require("../abstract/QCommerceScraper");
/**
 * Concrete implementation for Zepto's mobile API scraping.
 * Simulates mobile app requests and normalizes responses.
 */
class ZeptoScraper extends QCommerceScraper_1.QCommerceScraper {
    API_BASE_URL = process.env.ZEPTO_API_URL || 'https://api.mock-qcommerce.com/v1/search';
    constructor() {
        super('Zepto');
    }
    /**
     ...
     */
    async searchProduct(query, lat, lng) {
        try {
...
exports.ZeptoScraper = ZeptoScraper;
//# sourceMappingURL=ZeptoScraper.js.map